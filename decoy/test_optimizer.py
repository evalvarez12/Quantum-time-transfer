...
eta_es = 10**(- (channel_loss + 2*detector_loss)/10)
...
print('-------------')
print(opt.theoretical_vals([0.5, 0.2, 0.5], opt.conf))
print(opt.theoretical_vals([0.5, 0.2, 0.5], .5))
print('-------------')
print('-------------')
print('-------------')
...
print('Entangled source coincidences: ', ra*time*eta_es*0.6826 )
...
sig1 = np.ones(200)*ra*time*eta*(pm*(1- np.exp(-ms1)) + (1-pm)*(1 - np.exp(-vs[0])))
sig2 = np.ones(200)*ra*time*eta*(pm*(1- np.exp(-ms2)) + (1-pm)*(1 - np.exp(-vs[1])))
sig3 = np.ones(200)*ra*time*eta*(pm*(1- np.exp(-ms3)) + (1-pm)*(1 - np.exp(-vs[2])))
sig4 = np.ones(200)*ra*time*eta*(pm*(1- np.exp(-ms4)) + (1-pm)*(1 - np.exp(-vs[3])))
