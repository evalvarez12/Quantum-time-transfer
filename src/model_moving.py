...
class ModelMoving:
    def __init__(self, source='entangled', tags=False):
        ...
        self.velocity = 0 # m/s relative velocity between Alice and Bob
        ...
        # Jitter
        self.detector_jitter = 350e-12
        self.atmosphere_turbulence_jitter = 20e-12
        self.time_tag_jitter = 42e-12
        
        self.detector_dead_time = 30e-9
        
        self.background_counts_radiation_rate_sec =  5e12 # In seconds
    ...
    def get_loss(self):
        return self.channel_loss + 2*self.detector_loss
        
        
    def set_background_rate(self, background_counts_rate, dark_count_rate_sec=0):
        self.background_counts_radiation_rate_sec =  background_counts_rate * 1e12 # In seconds
    ...
    def generate_time_data(self, time_shift, start_time, total_protocol_time_sec, verbose=False):
        ############ System parameters
        # All time is set in unit of picoseconds 1e-12
        
        # detector_time_res = 50e-12  # time resolution of the detector - 50ps
        
        # total_protocol_time_sec = .001
        total_protocol_time = total_protocol_time_sec * 1e12 # protocol duration in picosec
        ...
        print('N_background : ', N_background_counts)
        ...
        alice_times = np.sort(alice_times)
        
        
        jitter_roll_bob = np.random.normal(0, bob_jitter, len(bob_pair_times))
        
        # Create time drift due to relative velocity
        time_drift = (bob_pair_times*self.velocity/299792458).astype(int)
        # print('---------------------------------------------------------------')
        # print(time_drift)
        
        bob_pair_times = bob_pair_times + jitter_roll_bob + light_travel_time + time_drift
